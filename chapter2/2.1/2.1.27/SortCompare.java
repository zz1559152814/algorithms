...
import algs4.InsertionX;
import algs4.BinaryInsertion;
...
public class SortCompare { 
    ...
    public static void main(String[] args) { 
        ...
        int cnt = N;
        StdDraw.setXscale(0,500000);
        StdDraw.setYscale(0,2000);
        StdDraw.setPenRadius(.01);

        for(int i=1; i<T; i++){
            time1 = timeRandomInput(alg1, cnt, 100); // Total for alg1. 
            // time2 = timeRandomInput(alg2, cnt, 50); // Total for alg2. 
